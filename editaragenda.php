    ...
    <body>
     ...
     <div class = "container">
            <div class = "row justify-content-center">
                <button id = "buttonEdicao" type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modal5">Editar Consulta</button>
            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class = "form-group mt-2" action="atualizaAgendaConsu.php" method="post"> 
                                    ...
                                    <?php
                                $sql = "SELECT * FROM atend WHERE id_atend = '$id'";
                                ...
                                ?>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" id="id" placeholder="" name = "id" value = "<?php echo $id?>" style = "display: none;" >    
