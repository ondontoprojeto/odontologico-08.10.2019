                            ...
                            ?>
                                <tr>                                    
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-secondary btn-sm"  style="color:#fff" href="#" onclick = "excluir(<?php echo $array['id_pessoa']?>)" role="button"><i  aria-hidden="true">PROCEDIMENTO</i></a>        

                                        <a class="btn btn-warning btn-sm"  style="color:#fff" href="editarAgendaConsu.php?id=<?php echo $id_atend?>" role="button"><i class="fa fa-pencil-square-o" aria-hidden="true">EDITAR</i></a>
